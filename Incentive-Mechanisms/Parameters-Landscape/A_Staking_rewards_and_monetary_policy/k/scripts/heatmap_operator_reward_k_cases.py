#!/usr/bin/env python3
"""Operator reward Pi(sigma, p; z0) heatmaps: k=500 vs k=1000 (+ difference)."""
...
def main() -> None:
    S, P = sigma_p_grids()
    vals_500 = operator_grid(S, P, z0, r_over_t, a0, c_i, m_i)
    vals_1000 = operator_grid(S, P, z0_alt, r_over_t, a0, c_i, m_i)
    ...
    fig.suptitle(
        ...
        rf"$a_0={a0}$, $c={c_i:.0f}$, $m={100*m_i:.0f}\%$",
        fontsize=FONT_SIZE,
    )
